...
## Рабочее приложение в этом репозитории

[`apps/market`](./apps/market/README.md) — витрина маркета `hub.sites` целиком: публичная страница, платное размещение карточек, кабинет владельца и кабинет компании на настоящем Postgres. Это контур будущей насадки mega-hub, а не макет.
