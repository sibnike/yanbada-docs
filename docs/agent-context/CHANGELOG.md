...
- Убраны статические заглушки: HTML-макеты Каракола и `demo-sites.json` (витрина больше не отдаёт зашитые данные без базы)
- `npm run db:reset` прогоняет миграции и seed прямо из `docs/sites/sql`
...
- Канон: [10-market-placement.md](./10-market-placement.md), [../sites/DEMO-KARAKOL.md](../sites/DEMO-KARAKOL.md)
